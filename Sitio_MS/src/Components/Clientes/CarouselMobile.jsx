        ...
        <Carousel data-bs-theme="dark" interval={1000} slide>
            ...
            <Carousel.Item>
                <div className="d-flex justify-content-around">
                    ...
                    <img id='img' className="d-block" src={img4} alt="Logo 2" />
            ...
            <Carousel.Item>
                <div className="d-flex justify-content-around">
                    ...
                    <img id='img' className="d-block" src={img8} alt="Logo 2" />
            ...
            <Carousel.Item>
                <div className="d-flex justify-content-around">
                    ...
                    <img id='img' className="d-block" src={img12} alt="Logo 2" />
            ...
            <Carousel.Item>
                <div className="d-flex justify-content-around">
                    <img id='img' className="d-block" src={img19} alt="Logo 1" />
                    <img id='img' className="d-block" src={img20} alt="Logo 2" />
